...
public:
    ...
    //logs
    std::shared_ptr<OldUserAnswer> addAnswerToLogs(std::shared_ptr<ConcreteTest> conc_test, std::shared_ptr<Question> quest, unsigned short grade);    std::vector<std::shared_ptr<OldUserAnswer>> getLogsForConcreteTests(std::shared_ptr<ConcreteTest> conc_test);
